          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">"Lost 9 Kg in 3 months using the calorie calculator and meal planner. The interface is so easy to use!"</p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white font-semibold mr-3">
                    S
                  </div>
                  <div>
                    <p className="font-semibold">Raghvendra Pratap Singh</p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">"The workout routines are perfect for my home gym setup. I've gained 6 Kg of muscle!"</p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center text-white font-semibold mr-3">
                    M
                  </div>
                  <div>
                    <p className="font-semibold">Priyansh Singh</p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-semibold">Ankur Singh</p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">HealthSphere</span>
              </div>
